...
export const LightBulbIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-amber-500" viewBox="0 0 20 20" fill="currentColor">
        <path d="M11 3a1 1 0 100 2h.01a1 1 0 100-2H11zM10 6a1 1 0 011 1v3a1 1 0 11-2 0V7a1 1 0 011-1zM10 12a1 1 0 100 2h.01a1 1 0 100-2H10z" />
...
export const ThumbsUpIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-emerald-500" viewBox="0 0 20 20" fill="currentColor">
    <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333V17a1 1 0 001 1h6.758a1 1 0 00.97-1.22l-1.95-6.503a1 1 0 00-.97-.777H9V6.5a1.5 1.5 0 00-3 0v3.833z" />
  </svg>
);

export const BuildingOfficeIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-sky-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const AccessibilityIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h3m-6.75 6.75h9.5M3 12a9 9 0 1118 0 9 9 0 01-18 0z" />
    </svg>
);
